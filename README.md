...
| `Daily NBA Sync (Game Logs)` | Daily at 10:00 UTC, or manually | Updates game logs for a selected season and date range. The date range defaults to the previous three days through today. |
